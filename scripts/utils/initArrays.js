...
export function sortArrays() {
    ingredientsRecipes = ingredientsRecipes.sort((a, b) => {return a.localeCompare(b);});
    appliancesRecipes = appliancesRecipes.sort((a, b) => {return a.localeCompare(b);});
    toolsRecipes = toolsRecipes.sort((a, b) => {return a.localeCompare(b);});
}
